...
@Controller
@RequestMapping("/transparentRPCXmlTest")
public class TransparentRPCXmlTestController {

    @RpcReference(microserviceName = "springmvc-provider1", schemaId = "transparentRPCXmlTest")
    ...
    public String testRpcReference(){
        ...
        System.out.println("-----------------TransparentRPCXmlTestController--------------------------");
    ...
    public String testXmlBeanUtils(){
        ...
        ITransparentRPCTestService transparentRPCTestService = BeanUtils.getBean("transparentRPCXmlXmlBeanUtils");
